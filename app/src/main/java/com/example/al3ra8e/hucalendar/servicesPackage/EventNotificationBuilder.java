...
public class EventNotificationBuilder {
    ...
    EventNotificationBuilder currnet = this ;



    public  void notify(final Context context, final Event event , long personId) {

        final Resources res = context.getResources();
        final String title = "New Event added "  ;  //res.getString(R.string.new_message_notification_title_template, comment.getComment());
    ...
    private PendingIntent getPendingIntent(Event event , long personId , Context context){
